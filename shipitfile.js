module.exports = (shipit) => {
    ...
    shipit.blTask('npm:start', async () => {
        ...
        // ln -s /opt/deploy-test/ecosystem.config.js /opt/deploy-test/current/ecosystem.config.js
        ...
        await shipit.remote(`cd /opt/deploy-test/current && nvm install 16 && npm install --production && npm run build:prod`)
    })
}
